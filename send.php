...
$mail = new PHPMailer;
$mail->CharSet = 'utf-8';
$mail->setFrom('no-reply@r1akademiya.ru', 'R-1 Академия');
//$mail->addAddress('akademiya_r-1@mail.ru');
//$mail->addAddress('r.s-oskar@mail.ru');
$mail->addAddress('baton921@mail.ru');
$mail->isHTML(true);
